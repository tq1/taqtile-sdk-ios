 ...
 *
 */
-(id)initWithPushId: (NSString *)id alert:(NSString *)alert content:(id)content type:(TQInboxMessageType)type status:(TQInboxMessageStatus)status complete:(BOOL)complete timestamp: (int) timestamp customStatus:(NSString *)customStatus;
 ...
 */
-(BOOL) addAlert: (NSString *)pushId alert:(NSString *) alert action:(NSString *)customAction;
