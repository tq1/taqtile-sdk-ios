...
/** shared
 *  Return an instance of itself, initializating it if there is no TQ1Analytics object. Since it's an shared object, it'll only create one.
 *
 * @return a TQ1Analytics object
 */
+ (TQ1Analytics *) shared;
